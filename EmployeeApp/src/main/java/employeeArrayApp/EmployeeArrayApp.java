...
public class EmployeeArrayApp {
	...
	static EmployeeDAOInterface Eap;

	public static void main(String[] args) {

		EmployeeArrayApp  employeeApp = new EmployeeArrayApp ();
		int choice = 0;
		boolean flag = true;
	...
	private void DisplayEmployeeSalaryWiseCount() {
		...
		Map<Double, Integer> maps = Eap.DisplayEmployeeSalaryWiseCount();
